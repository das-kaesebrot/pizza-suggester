...
public class AdminMenuServiceImpl implements AdminMenuService {
    ...
    private String getBotStats(PizzaSuggesterBot bot) {
        return String.format("Handled updates: %d\nCached users: %d\nVenues: %d\nTotal admin keys: %d\nUnredeemed admin keys: %d\nRunning since: %s", bot.getHandledUpdatesCount(), cachedUserRepository.count(), venueRepository.count(), adminKeyRepository.count(), adminKeyRepository.countAllByClaimantIsNull(), bot.getStartedAt());
    }
