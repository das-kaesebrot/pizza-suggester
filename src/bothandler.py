...
def handleUpdate(update_dict):
    ...
    TextStart = """Hi, ich bins\\! Der KantineBot {emojiSweatSmile}
...
{emojiPin} /addresse \\- Daten der Holzofen\\-Kantine

Guten Appetit\\! {emojiPizza}
""".format(emojiSweatSmile = emojiSweatSmile, emojiPizza = emojiPizza, emojiDie = emojiDie, emojiPin = emojiPin)
...
"""
    ...
    TextEnd = """Guten Appetit\\! {emojiFaceSavouringFood}{emojiForkKnife}
""".format(emojiFaceSavouringFood = emojiFaceSavouringFood, emojiForkKnife = emojiForkKnife)
...
{{TextPizza3}}
{TextEnd}
""".format(emojiPizza = emojiPizza, TextEnd = TextEnd)

    TextRandom = """{emojiDie} Hi {{firstName}}, hier ist deine Zufallspizza:\n
{{TextPizza}}
{TextEnd}
""".format(emojiDie = emojiDie, TextEnd = TextEnd)
